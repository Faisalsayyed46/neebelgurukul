...
class Employee extends Person //derived class of base class person
{
	int id;
	double salary;
...
class Teacher extends Employee //teacher is a derive class of base class employee 
{
	String subject;
...
class Principal extends Teacher //principal is a base class of teacher
{
	int experience;
...
public class PersonClassDemo {
	...
	public static void main(String[] args) {
		...
		Teacher t1 = new Teacher("Teacher1",30,101,50000,"Maths");
		Teacher t2 = new Teacher("Teacher2",40,102,60000,"History");
		Teacher t3 = new Teacher("Teacher3",50,103,45000,"Science");
		
		Principal p1 = new Principal("Principle",55,104,80000,"Maths",20);
		
		Officer o1 = new Officer("Officer",38,105,70000,"Sales");
